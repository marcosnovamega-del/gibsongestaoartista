...
const Modals = {
                ...
                <div class="modal">
                    ...
                    <div class="modal-body">
                        <form id="artistaForm" onsubmit="Modals.submitArtistaForm(event, '${artistaId || ''}')">
                            ...
                            <div class="form-group">
                                <label>Duração do Show <span style="font-size:11px;color:var(--text-muted);font-weight:400;">(pré-preenchido na proposta)</span></label>
                                <input type="text" name="duracao_show" value="${artista?.duracao_show || ''}" placeholder="Ex: 90 min (noventa minutos) – 1h30m">
                            </div>
    ...
    async submitArtistaForm(event, artistaId) {
        ...
        const data = {
            ...
            duracao_show: formData.get('duracao_show') || null,
            dados_bancarios: {
